...
export default function EditSynagogueModal({
  synagogue,
  onClose,
}: EditSynagogueModalProps) {
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditedSynagogue({
                    ...editedSynagogue,
                    titleRightBottom: e.target.value,
                  })
                }
                className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors"
                placeholder="הזן כותרת..."
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditedSynagogue({
                    ...editedSynagogue,
                    titleLeftBottom: e.target.value,
                  })
                }
                className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors"
                placeholder="הזן כותרת..."
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setEditedSynagogue({
                    ...editedSynagogue,
                    contentLeftBottom: e.target.value,
                  })
                }
                className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors"
                rows={4}
