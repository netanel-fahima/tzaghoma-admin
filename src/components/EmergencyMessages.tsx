...
import { AlertTriangle, ChevronDown, ChevronUp, Trash } from "lucide-react";
import {
  collection,
  addDoc,
  query,
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setNewMessage({ ...newMessage, city: e.target.value })
                }
            ...
            <div className="flex justify-between items-start">
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="text-red-600 hover:text-red-800 transition-colors mr-[20%]"
                  title="מחק הודעה"
                >
