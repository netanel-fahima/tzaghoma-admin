...
const backgrounds = [
  { id: 'background-1', url: new URL('../img/final-back.jpg', import.meta.url).href },
  { id: 'background-2', url: new URL('../img/final_background.jpg', import.meta.url).href },
  { id: 'background-3', url: new URL('../img/pikud_haaoref.jpg', import.meta.url).href },
  { id: 'background-4', url: new URL('../img/pikud_haaoref.old.jpg', import.meta.url).href },
  { id: 'background-5', url: new URL('../img/pikud_haaoref_tt.jpg', import.meta.url).href },
];

export default function BackgroundSelectorModal({ synagogue, onClose }: BackgroundSelectorModalProps) {
  const [selectedBackground, setSelectedBackground] = useState(synagogue.backgroundImage || backgrounds[0].url);
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4" dir="rtl">
        ...
        <div className="mb-6">
          ...
          <div 
            className="w-full h-96 rounded-lg border-2 border-gray-200 bg-center bg-cover bg-no-repeat"
